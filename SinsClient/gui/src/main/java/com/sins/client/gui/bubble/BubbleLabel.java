package com.sins.client.gui.bubble;
...
public class BubbleLabel extends Label {
	...
	public BubbleLabel(String arg0, Node arg1) {
		super(arg0, arg1);
		init();
	}

	public BubbleLabel(String arg0) {
		super(arg0);
		init();
	}

	public BubbleLabel(BubbleSpec bubbleSpec) {
		super();
		this.bs = bubbleSpec;
		init();
	}

	public BubbleLabel(String arg0, Node arg1,BubbleSpec bubbleSpec) {
		super(arg0, arg1);
		this.bs = bubbleSpec;
		init();
	}

	public BubbleLabel(String arg0,BubbleSpec bubbleSpec) {
		super(arg0);
		this.bs = bubbleSpec;
		init();
	}
